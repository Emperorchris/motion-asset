...
@section('adminContent')
    <form action="{{ route('sendemail', $user->id) }}" method="post">
        @csrf
        <div class="row ">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Send Email To Users</h4>
                        ...
                        <div class="main-container">
                            ...
                            <textarea id="editor" name="message">
                                <p>
                                    <span class="text-big">Hi</span> <span style="color:rgb(251,87,11);"
                                        class="text-big"><strong>{{ $user->firstname }}</strong></span><span
                            ...
                            <button class="btn-success btn btn-lg float-end mt-4">Send Email</button>
                        </div>
                    </div>
